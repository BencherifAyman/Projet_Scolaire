...
<html>
  ...
  <body>
        ...
        <nav class="menu-déroulant">
          <ul> 
              ...
              <li class="menu-déroulant"><a href="index.php">Mangas</a>
                  <ul class="submenu">
                    <li><a href="hxh.php">HunterxHunter</a></li>   
                  </ul>
              </li>
              <li class="menu-déroulant"><a href="index.php">Jeux</a>
                  <ul class="submenu">
                      <li><a href="#">Article 1</a></li>
                      <li><a href="#">Article 1</a></li>
                  </ul>
               </li>
              <li class="menu-déroulant"><a href="index.php">Connexion</a>
                <ul class="submenu">
                  <div id="content">
    <div class="leftboxe">
    ...
    <div class="step">
      ...
      <center><img src="headaccueil.jpg" alt="Photo représentant une image d'anime ainsi qu'une image de gaming avec plusieurs personnages de jeux vidéo ainsi que de mangas connu"></center><p>
                     ...
                     <h1><center>Actualités Mangas </center></h1></br>
                       <ul>
                        ...
                        Source du synopsis <a href="https://fr.wikipedia.org/wiki/Weathering_with_You"> ici </a>
                          ...
                          <li><h3>Court métrage Cyprien (Minrori)</h3></li></br>
...
<audio controls="controls">
  <source src="jojo.mp3" type="audio/mp3" />
